...
#' Combine Moran's I Results
#'
#' This function combines Moran's I results from different sources and sorts them based on the specified statistics.
#'
#' @param traj_feature A list containing Moran's I results from trajectory analysis.
#' @param sp_feature A list containing Moran's I results from spatial analysis.
#' @param overall_feature A character vector of features to be combined.
#'
#' @return A list containing significant features, their statistics, and correlation with trajectory.
#'
#' @export
combine_moran_results <- function(traj_feature, sp_feature, overall_feature) {
