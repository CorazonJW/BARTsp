...
start_cells = spt.set_start_cells(adata_sub, select_way='cell_type', cell_type='Enterocyte_Progenitor')
...
plt.savefig("~/spaTrack_ptime_spatial_plot.png", dpi=300, bbox_inches='tight')



##### 3. Predict trajectory-related genes
sub_adata_path = adata_sub[adata_sub.obs['cluster'].isin(["Enterocyte_Progenitor", "Enterocyte_Immature", "Enterocyte_Mature"])]
